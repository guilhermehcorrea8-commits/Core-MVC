...
namespace SistemaPedidos.Controllers
{
    public class ItensPedidoController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ItensPedido.Include(i => i.Pedido).Include(i => i.Produto);
        ...
        public async Task<IActionResult> Create([Bind("Id,PedidoId,ProdutoId,Quantidade,PrecoUnitario")] ItemPedido itemPedido)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produtos, "Id", "Nome", itemPedido.ProdutoId);
            return View(itemPedido);
        }
     ...
     int id,
     [Bind("Id,PedidoId,ProdutoId,Quantidade,PrecoUnitario")] ItemPedido itemPedido)
        {
            if (id != itemPedido.Id)
            {
                return NotFound();
