...
namespace SistemaAgendamento.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,DuracaoMinutos")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Preco,DuracaoMinutos")] Servico servico)
        {
            if (id != servico.Id)
            {
                return NotFound();
