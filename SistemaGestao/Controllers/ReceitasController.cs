...
namespace SistemaGestao.Controllers
{
    ...
    public class ReceitasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Receitas.Include(r => r.Categoria);
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Valor,Data,CategoriaId")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Valor,Data,CategoriaId")] Receita receita)
        {
            if (id != receita.Id)
            {
                return NotFound();
